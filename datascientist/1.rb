...
nbjournalistesaude = 0
nbjournalistesavecnuméro = 0
nbjournalistesavecmajaudebut = 0
nbjournalistesmaj = 0
undescore = 0
nb = journalistes.length.to_i
puts "il y a #{nb} dans cet array"
for i in (0..journalistes.length)
 ...
 if (/@[A-Z]/.match("#{journalistes[i]}"))
  nbjournalistesavecmajaudebut += 1
 end
 if (/[A-Z]/.match("#{journalistes[i]}"))
 nbjournalistesmaj += 1
 end
 if (/@epenser/.match("#{journalistes[i]}"))
  epenser = i
 end
 if (/_/.match("#{journalistes[i]}"))
  if (/__/.match("#{journalistes[i]}"))
  undescore += 2   
  elsif (/@([A-Za-z]{1,}_){2,}/.match("#{journalistes[i]}"))
   undescore += 2
  else
   undescore += 1
  end
...
pluspetitauplusgrand = journalistes.sort_by(&:length)
puts nbjournalistesavecnuméro
puts nbjournalistesaude
puts nbjournalistesavecmajaudebut
puts nbjournalistesmaj
puts undescore
print journalistes.sort
puts "
"
for i in (0..49)
 puts pluspetitauplusgrand[i]
end
puts epenser
